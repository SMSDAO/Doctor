...
Open Issues: ${currentRepo.metrics?.openIssues ?? 'N/A'}
Open PRs: ${currentRepo.metrics?.openPRs ?? 'N/A'}
Contributors: ${currentRepo.metrics?.contributors ?? 'N/A'}
Recent Commits: ${currentRepo.metrics?.commits ?? 'N/A'}
